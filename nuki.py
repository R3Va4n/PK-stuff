...
translations = {
    'en': {
        ...
        'not_correct_image': 'Nuki blinked, this could\'nt be correct',
        'error_processing_image': 'Error processing image: ',
        'first_screen': "Once upon a time, there was a small, adorable guinea pig named Nuki.<br>Despite being visually impaired, Nuki's heart was full of curiosity and determination.<br>Every morning, he followed the same routine, believing it would set the tone for a perfect day.<br>At precisely 7 a.m., Nuki would rise from his cozy bed and make his way to the bathroom.<br>There, he would gaze into the mirror, eager to see his reflection.<br>He glanced and thought: How do I look today?",
